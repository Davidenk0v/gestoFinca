...
const Carrousel = () => {
  ...
  return (
    <section className="relative h-[50vh] overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-black opacity-60 sm:bg-transparent sm:from-gray-900/95 sm:to-gray-900/25 ltr:sm:bg-gradient-to-r rtl:sm:bg-gradient-to-l"></div>
      </div>
